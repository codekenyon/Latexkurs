...
\usecolortheme[RGB={85,170,255}]{structure} % Färbt Strukturelemente in einen Blauton
\usecolortheme{seahorse}                    % Farben für Elemente des outer themes
\usecolortheme{orchid}                      % Farben für Elemente von inner themes
\usecolortheme{sidebartab}                  % Farbliche Hervorhebung der aktuellen Folie

\setbeamercolor{example text}{fg=olive}     % Etwas angenehmere Farbe für Beispielkästen
\setbeamercovered{highly dynamic}           % Später aufgedeckte Teile werden immer sichtbarer
